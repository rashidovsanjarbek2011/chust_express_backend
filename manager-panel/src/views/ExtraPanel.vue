...
export default {
  ...
  methods: {
    loadData() {
      const territories = localStorage.getItem('manager_extra_territories');
      const workers = localStorage.getItem('manager_extra_workers');
      const equipment = localStorage.getItem('manager_extra_equipment');
      const vehicles = localStorage.getItem('manager_extra_vehicles');
    ...
    saveData() {
      localStorage.setItem('manager_extra_territories', JSON.stringify(this.territories));
      localStorage.setItem('manager_extra_workers', JSON.stringify(this.workers));
      localStorage.setItem('manager_extra_equipment', JSON.stringify(this.equipment));
      localStorage.setItem('manager_extra_vehicles', JSON.stringify(this.vehicles));
    },
    addTerritory() {
